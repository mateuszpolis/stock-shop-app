...
function ProductCardSmall({
  ...
  if (price_before != null) {
    return (
      <div className="w-full sm:w-96 relative mb-2 p-2 rounded-lg flex justify-between items-center  overflow-hidden h-20 z-30 hover:bg-neutral-300 dark:hover:bg-neutral-800  transition-all duration-75">
        <Link to={`/product/${id}`}>
          <img
            alt={name}
            src={img ? img : picture}
    ...
    return (
      <div className="w-full sm:w-96  relative mb-2 p-2 rounded-lg flex justify-between items-center overflow-hidden h-20 z-30 hover:bg-neutral-300 dark:hover:bg-neutral-800  transition-all">
        <Link to={`/product/${id}`}>
          <img
            alt={name}
            src={img ? img : picture}
